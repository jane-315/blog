...
- [GautierArcin's demo with next translate](https://jane-wang.vercel.app/) - includes translation of mdx posts, [source code](https://github.com/GautierArcin/tailwind-nextjs-starter-blog/tree/demo/next-translate)
...
1. JS (official support) - `npx degit https://github.com/jane-315/blog.git` or TS (community support) - `npx degit jane-315/blog#typescript`
...
Using the template? Support this effort by giving a star on GitHub, sharing your own blog and giving a shutout on Twitter or be a project [sponsor](https://github.com/sponsors/jane-315).
