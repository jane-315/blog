...
I hope you enjoy the new features and improvements in V2. If you have any feedback or suggestions, feel free to open an issue or reach out to me on [Twitter](https://twitter.com/jan3wang).

## Support

Using the template? Support this effort by giving a star on GitHub, sharing your own blog and giving a shoutout on Twitter or be a project [sponsor](https://github.com/sponsors/jane-315).

## Licence

[MIT](https://github.com/jane-315/blog/blob/main/LICENSE) © [Timothy Lin](https://www.timrlx.com)
